...
mkdir $2/star_rsem
\time -v -o $2/rsem/time.txt rsem-calculate-expression --fragment-length-mean $3 --fragment-length-sd $4 --no-bam-output --star --star-gzipped-read-file -p $THREAD $1 ./index/star_rsem/grch38 $2/star_rsem/result 2> $2/star_rsem/screen.log 

mkdir $2/bowtie2_rsem
\time -v -o $2/rsem/time.txt rsem-calculate-expression --fragment-length-mean $3 --fragment-length-sd $4 --no-bam-output  --bowtie2 -p $THREAD $1 $2 ./index/bowtie2_rsem/grch38 $2/bowtie2_rsem/result 2> $2/bowtie2_rsem/screen.log 
