...
mkdir $3/star_rsem
\time -v -o $3/star_rsem/time.txt rsem-calculate-expression --no-bam-output --star --paired-end -p $THREAD $1 $2 ./index/star_rsem/grch38 $3/star_rsem/result 2> $3/star_rsem/screen.log 

mkdir $3/bowtie2_rsem
\time -v -o $3/bowtie2_rsem/time.txt rsem-calculate-expression --no-bam-output  --bowtie2 --paired-end -p $THREAD $1 $2 ./index/bowtie2_rsem/grch38 $3/bowtie2_rsem/result 2> $3/bowtie2_rsem/screen.log 
